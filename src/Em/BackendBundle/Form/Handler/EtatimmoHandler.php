...
class EtatimmoHandler{
   ...
   public  function  onSuccess(){
    ...
    public  function  onSuccessupdate( $dataEntity){
        ...
        $dataEntity->setLibelle($_POST['em_backendbundle_etatimmo']['libelle']) ;

        $dataEntity->setSlug($this->myslug($_POST['em_backendbundle_etatimmo']['libelle'])) ;
